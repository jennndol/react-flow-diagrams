...
import { dragWire, perturbWire, cleanPoints, resetWire } from '../../actions/wireActions';
...
const mapDispatchToProps = (dispatch, props) => ({
  ...
  dragWire: (point, start, allowSelfConnect) => dispatch(dragWire(props.wire.id, point, start, allowSelfConnect)),
  endWireDrag: start => {
...
const WireDragContainer = connect(mapStateToProps, mapDispatchToProps)(WireDragComponent);
